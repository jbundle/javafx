...
import org.jbundle.base.screen.view.javafx.calendar.CalendarTableModel;
 ...
 */
public class FCalendarScreen extends FBaseGridTableScreen
    implements MyListSelectionListener
{
     ...
     */
    public FCalendarScreen(ScreenField model, boolean bEditableControl)
    {
        this();
