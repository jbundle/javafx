...
public class FRadioButton extends FToggleButton
{
     ...
     */
    public FRadioButton(ScreenField model, boolean bEditableControl)
    {
        this();
    ...
    public Component setupControl(boolean bEditableControl)
    {
        ...
        control.setIconTextGap(org.jbundle.base.screen.control.javafx.util.ScreenInfo.EXTRA_COL_SPACING);
        if (bEditableControl)
        {
