 ...
 */
public class FBaseGridTableScreen extends FBaseGridScreen
{
    /**
     ...
     */
    public FBaseGridTableScreen(ScreenField model, boolean bEditableControl)
    {
        this();
