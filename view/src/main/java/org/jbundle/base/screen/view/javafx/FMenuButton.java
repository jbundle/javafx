...
public class FMenuButton extends FCannedBox
{
     ...
     */
    public FMenuButton(ScreenField model,boolean bEditableControl)
    {
        this();
    ...
    {
//      This starting code is the same as FButtonBox, but I use JUnderlinedButtons instead of JButtons;
