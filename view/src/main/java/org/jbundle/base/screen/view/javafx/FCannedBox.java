 ...
 */
public class FCannedBox extends FButtonBox
    implements PropertyChangeListener
{
     ...
     */
    public FCannedBox(ScreenField model, boolean bEditableControl)
    {
        this();
    ...
    public int selectCurrentRow(boolean bLockRecord)
    {
        ...
        FGridScreen vGridScreen = (FGridScreen)gridScreen.getScreenFieldView();
    ...
    {
        public boolean startEditor(FCannedBox control, String text, String schema);
    }
    /**
     * A view specific function - open a file.
     * @return True if successful.
