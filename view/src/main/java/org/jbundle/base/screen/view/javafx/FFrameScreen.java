 ...
 */
public class FFrameScreen extends FBasePanel
    implements WindowListener
{
     ...
     */
    public FFrameScreen(ScreenField model, boolean bEditableControl)
    {
        this();
    ...
    public Component setupControl(boolean bEditableControl)
    {
        ...
        control.setFocusTraversalPolicy(new org.jbundle.base.screen.control.javafx.MyFocusTraversalPolicy());
    ...
    public ScreenInfo getScreenInfo()
    {
        ...
        if (frameScreen.getAppletScreen() != null)
            return ((FScreenField)frameScreen.getAppletScreen().getScreenFieldView()).getScreenInfo();
        else
            return null;
    } // Screen information
    /**
    ...
    public Dimension getFrameSize(JFrame frame)
    {
        ...
        if (toolkit != null)
        {
            ...
            Rectangle m_dimFarthest = ((FScreenField)((BasePanel)this.getScreenField()).getSField(0).getScreenFieldView()).calcBoxShape(new Point(20, 20));
            if (dimScreen != null)
            {
